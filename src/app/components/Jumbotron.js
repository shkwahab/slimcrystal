                ...
                <div className=" p-5">
                    <div className=' mb-10  '>
                        ...
                        <div>
                            ...
                            <div className='uppercase flex text-center justify-center
                             md:my-3 my-2 lg:my-4 text-black md:text-5xl
                              sm:text-4xl text-2xl lg:text-6xl font-primary font-bold'>
                                <p>
                            ...
                            <div className=" animate-pulse flex justify-center">
                                <Link href={props.CBLINK}>
                                    ...
                                    md:px-4 px-2 sm:px-3 lg:px-6 md:py-3 py-2 lg:py-4  
                                     md:text-3xl sm:text-2xl text-2xl lg:text-4xl font-optional font-semibold  bg-gradient-to-b from-[#F6BA06] to-yellow-400 uppercase rounded-md  text-black'>
